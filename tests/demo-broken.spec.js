/**
 * demo-broken.spec.js -- SelfHeal Live Demo Test
 * This test is deliberately broken to showcase the AI Dev Assistant.
 * 
 * Instructions:
...
export default async function demoTest(page) {
    console.log('\n  SelfHeal Live AI Demo');
    console.log('  ----------------------------');
    ...
    try {
        await healClick(page, 'button.checkout-btn-final', {
    ...
    console.log('\n  ----------------------------');
    console.log('  Demo complete. Check the SelfHeal dashboard for stats!\n');
}
