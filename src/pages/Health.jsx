        ...
        <div className="xl:col-span-8 space-y-5">
              ...
              {[
                {
                  ...
                  bg: advisory?.maskType?.includes('N95') ? 'bg-amber-500/10 border-amber-500/20' : 'bg-slate-900/50 border-slate-700/30',
                },
                {
                  label: 'Outdoor Limit',
          ...
          <div className="bg-slate-800/40 border border-slate-700/40 rounded-xl p-6">
            ...
            <AnimatePresence mode="wait">
              ...
              >
                <div className={`p-5 rounded-xl border ${advisory?.isDanger ? 'bg-red-500/5 border-red-500/20' : 'bg-slate-900/50 border-slate-700/30'}`}>
